...
provenance: [[ratcliffe-grechuk-2024]]
---
...
|---|---|---|
| $(p,p,p)$ | all $p\geq 3$ | Frey + modularity + Ribet — Wiles (FLT) [[fermat-last]] |
...
[[frey-level-lowering-obstruction]], which shows the classical Frey /
...
## Provenance caveat
References here follow the survey [[ratcliffe-grechuk-2024]]'s internal labels; the individual
