...
- Conversely $g(\mu)$ **grows** at low energy (IR), where perturbation fails
  and confinement is expected [[mass-gap-confinement]].
...
control in the IR**: the mass gap [[mass-gap-confinement]] lives where
$g$ is large. The dimensional-transmutation scale
$\Lambda_{\text{YM}}=\mu\,e^{-1/(2\beta_0 g^2)}$ [[yang-mills-theory]] is
