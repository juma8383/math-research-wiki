---
type: theorem
name: Cattani–Deligne–Kaplan (Hodge locus is algebraic)
created: 2026-08-24
tags: [algebraic-geometry, hodge-theory, variation-of-hodge-structure]
used-in: [[hodge_conjecture]]
provenance: [[hodge-survey]]
---

# Cattani–Deligne–Kaplan: the Hodge locus is algebraic

## Statement

In a smooth projective family $\pi:\mathcal X\to S$, fix a Hodge class
$\xi_s\in\mathrm{Hdg}^p(\mathcal X_s)$ at a point $s\in S$. The **Hodge locus**
— the set of $t\in S$ for which a flat extension of $\xi_s$ remains a Hodge
class at $\mathcal X_t$ — is a **countable union of closed algebraic subsets
of $S$** [hodge-cattani-deligne-kaplan] (Cattani–Deligne–Kaplan).

## Why it is evidence for the Hodge conjecture

If Hodge classes were "random analytic" objects, their loci would be
