...
conjecture = Col_min(N)=1 for all N. [used-in: [[collatz_conjecture]] [[collatz-map]]]
...
start eventually drops below itself. [used-in: [[collatz-density-results]]]
...
almost-all bound toward smaller powers. [used-in: [[collatz-density-results]]]
...
still far from "almost all reach 1"). [used-in: [[collatz-density-results]]]
...
[used-in: [[collatz-tao-almost-bounded]] [[average-vs-pointwise-control]]]
...
transcendence lower bounds for small m. [used-in: [[collatz-cycle-bounds]]]
...
[used-in: [[collatz-cycle-bounds]] [[cycle-exclusion-linear-forms]]]
...
[used-in: [[collatz-conway-undecidability]]]
...
contracting — no divergent trajectory expected. [used-in: [[collatz-conway-undecidability]]]
...
pointwise — this gap IS the obstruction. [used-in: [[average-vs-pointwise-control]] [[collatz-map]]]
