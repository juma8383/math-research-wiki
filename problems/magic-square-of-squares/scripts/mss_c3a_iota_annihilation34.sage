# mss_c3a_iota_annihilation34.sage -- fix of v33's variable slip (used the
# ring generator name 'w' instead of 'w2' inside the term loop).
import sys, time
def out(*a):
...
out('=== I4b: fresh-ring rebuild, variable fixed ===')
