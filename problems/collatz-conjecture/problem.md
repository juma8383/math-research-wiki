...
tools: [[collatz-map]] [[collatz-density-results]] [[collatz-tao-almost-bounded]] [[collatz-cycle-bounds]] [[collatz-conway-undecidability]] [[average-vs-pointwise-control]] [[cycle-exclusion-linear-forms]]
...
The **Collatz map** $T:\mathbb N^+\to\mathbb N^+$ [[collatz-map]]:
...
- **Density / almost-all results** [[collatz-density-results]]:
  ...
  - Krasikov–Lagarias 2003: $\#\{N\le x:\mathrm{Col}_{\min}(N)=1\}\gg x^{0.84}$
    [collatz-kl-count].
- **Tao 2019/2022** [[collatz-tao-almost-bounded]]: for any
  ...
  conjecture."
- **Cycle exclusion** [[collatz-cycle-bounds]] [[cycle-exclusion-linear-forms]]:
...
- **Average contraction heuristic** [collatz-average-contraction]: the
  ...
  (distributional, NOT pointwise) [[average-vs-pointwise-control]].
- **Undecidability context** [[collatz-conway-undecidability]]:
...
$N$ is deterministic and uncontrolled [[average-vs-pointwise-control]].
...
- **(a) No nontrivial cycle** — a **Diophantine / transcendence** problem
  ...
  $m\le75$) [[cycle-exclusion-linear-forms]] — echoes Beal's
